...
<img width="955" alt="Screenshot showing that the axios PR was merged and that the 2 others were closed" src="https://github.com/hemantr-dev/skills-secure-repository-supply-chain/blob/main/.github/images/axios-pr-merged-others-closed.png?raw=true" />
